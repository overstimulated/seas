...
<script src="<?php echo Yii::app()->request->baseUrl ?>/js/js/jquery-1.4.2.min.js" type="text/javascript"></script>
<script src="<?php echo Yii::app()->request->baseUrl ?>/js/js/cufon-yui.js" type="text/javascript"></script>
<script src="<?php echo Yii::app()->request->baseUrl ?>/js/js/cufon-replace.js" type="text/javascript"></script>
<script src="<?php echo Yii::app()->request->baseUrl ?>/js/js/Myriad_Pro_400.font.js" type="text/javascript"></script>
<script src="<?php echo Yii::app()->request->baseUrl ?>/js/js/Myriad_Pro_600.font.js" type="text/javascript"></script>
<!--[if lt IE 7]>
...
<!-- .logo -->
		<div class="logo">
			<a href="index.html"><img src="<?php echo Yii::app()->request->baseUrl ?>/images/logo.gif" alt="" /></a>
		</div>
<!-- /.logo -->
